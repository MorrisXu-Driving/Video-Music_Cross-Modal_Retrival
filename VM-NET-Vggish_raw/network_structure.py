...
class Model_structure:
    ...
    def construct(self):
        ...
        self.x_data = tf.placeholder(tf.float32, [None, 1, 62, self.opts.x_dim], name='X_data')
        ...
        self.x_embed, self.x_fusion = self.x_net.construct(self.x_data, keep_prob=self.keep_prob, is_linear=self.opts.is_linear, is_training=self.is_training)
        ...
        self.loss_single_x = esl_net.construct(self.x_fusion, self.x_embed, self.K, 'Triplet_Strcture_x_Net')
