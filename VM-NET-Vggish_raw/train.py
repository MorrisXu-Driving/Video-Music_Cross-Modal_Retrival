...
flags.DEFINE_string('summaries_dir', "./models/MV_9k_efficient_b5_Avgpool_VGGISH_RAW_ POOL_Structure_Nonlinear_single_loss_margin_0.5_emb_512_epochs_101_COV2D_4_KERNEL_2&3", 'Directory to put the summary and log data.')
...
learning_rate_ = tf.train.exponential_decay(FLAGS.learning_rate, \
                                            global_step_,decay_step, 0.96, staircase=True)
