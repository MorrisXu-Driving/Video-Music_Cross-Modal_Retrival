...
def waveform_to_examples(data, sample_rate, return_tensor):
  ...
  """
    ...
    if sample_rate != vggish_params.SAMPLE_RATE:
        data = np.take(resampy.resample(data, sample_rate, vggish_params.SAMPLE_RATE), \
                       indices=range(0,int(60*vggish_params.SAMPLE_RATE)), axis = 0, mode='warp') # cut first 60s 
